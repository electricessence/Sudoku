...
static class Solver
{
    ...
    */
    ...
    static void display(Dictionary<string, string> values)
    {
        print_board(values);
    }
    ...
    static List<string> top95 = @"4.....8.5.3..........7......2.....6.....8.4......1.......6.3.7.5..2.....1.4......
...
3...8.......7....51..............36...2..4....7...........6.13..452...........8..".Split('\n').ToList();
    ...
    static void solveGrid(string name, string grid)
    {
        Console.WriteLine("{0}: {1}", name, grid);
