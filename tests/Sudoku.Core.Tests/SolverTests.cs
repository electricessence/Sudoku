...
internal class SolverTests
{
	...
	//	static readonly string grid1 = "003020600900305001001806400008102900700000008006708200002609500800203009005010300";
	//	static readonly string grid2 = "4.....8.5.3..........7......2.....6.....8.4......1.......6.3.7.5..2.....1.4......";
	//	static readonly string hard1 = ".....6....59.....82....8....45........3........6..3.54...325..6..................";

	//	static readonly List<string> top95 = @"4.....8.5.3..........7......2.....6.....8.4......1.......6.3.7.5..2.....1.4......
	...
	//			PrintBoard(Search(ParseGrid(game)));
	//			Search(ParseGrid(game));
	//		}
	...
	//	// Warm-up for at least 100ms. Discard result.
	//	warmup ??= fn;
	...
	//	watch.Start();
	//	var solution = Search(ParseGrid(grid));
	...
	//{
	//	Report("grid1", Measure(() => { Search(ParseGrid(grid1)); }, times: 1));
	//	Report("grid2", Measure(() => { Search(ParseGrid(grid2)); }, times: 1));
	//	Report("top95", Measure(() => { top95.ForEach((game) => { Search(ParseGrid(game)); }); }, times: 1));
	//}
